...
if __name__ == '__main__':
    ...
    # model_checkpoint = keras.callbacks.ModelCheckpoint("saved_models\\best_checkpoint_RNNs_LSTM_forecasting.h5",
    #                                                    save_best_only=True)
    ...
    model = keras.models.load_model('saved_models\\best_checkpoint_RNNs_LSTM_forecasting.h5')
